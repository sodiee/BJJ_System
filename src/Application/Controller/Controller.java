...
public class Controller {
    ...
    public JiuClass createJiuClass(int number, int rating, String gym, Wear gear, String topic, Belt belt, Fighter fighter) {
        JiuClass jiuClass = new JiuClass(number, rating, gym, gear, topic, fighter);
    ...
    public void initStorage() {
        ...
        createJiuClass(1, 7, "The Grappling Lab", Wear.NOGI, "Can't remember", Belt.WHITE, fighter);
        createJiuClass(2, 7, "The Grappling Lab", Wear.NOGI, "Open guard", Belt.WHITE, fighter);
        createJiuClass(3, 7, "The Grappling Lab", Wear.NOGI, "Can't remember", Belt.WHITE, fighter);
        createJiuClass(4, 8, "The Grappling Lab", Wear.NOGI, "Turtle", Belt.WHITE, fighter);
        createJiuClass(5, 7, "The Grappling Lab", Wear.NOGI, "Can't remember", Belt.WHITE, fighter);
        createJiuClass(6, 7, "The Grappling Lab", Wear.NOGI, "Can't remember", Belt.WHITE, fighter);
        createJiuClass(7, 7, "The Grappling Lab", Wear.NOGI, "Can't remember", Belt.WHITE, fighter);
        createJiuClass(8, 7, "The Grappling Lab", Wear.NOGI, "Can't remember", Belt.WHITE, fighter);
        createJiuClass(9, 7, "The Grappling Lab", Wear.NOGI, "Standing takedown", Belt.WHITE, fighter);
        createJiuClass(10, 8, "The Grappling Lab", Wear.GI, "Sprawling, single leg lock, double leg lock", Belt.WHITE, fighter);
        try {
            createConnection();
